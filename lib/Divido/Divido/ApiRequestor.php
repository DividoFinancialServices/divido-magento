...
class Divido_ApiRequestor
{
   ...
   */
  public $apiKey = "sandbox_C0D4341DE.facf791ddc47d87452901986ff2f3310";
  ...
  private function _requestRaw($method, $url, $params)
  {
    ...
    if (!$myApiKey) {
      $msg = 'No API key provided.  (HINT: set your API key using '
           ...
           . 'the Divido web interface.  See http://docs.divido.co/api for '
           . 'details, or email support@divido.co if you have any questions.';
...
print self::encode($params);
  ...
  public function handleCurlError($errno, $message)
  {
    ...
    $msg .= " let us know at support@divido.co.";
  ...
  private function checkSslCert($url)
  {
    ...
    if (self::isBlackListed($pemCert)) {
      throw new Divido_ApiConnectionError(
          ...
          'data to that server.  Please email support@divido.co if you need '.
